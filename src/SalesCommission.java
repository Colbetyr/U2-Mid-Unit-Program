...
//2.1 calculate - hourly rate  * hours = salary
//2.2 calculate - cars sold * car price but only output commissions = "bonuses".
...
public class SalesCommission {
    ...
    public static void main(String[] args) {
        ...
        double hoursWorked = getInput("How many hours did you do (Between 30 to 40) ?");
        double commissionPercent = getInput("What is your commission?");
        double totalSales = getInput("How much did you sell in total?");


        double pay =  commission(commissionPercent, totalSales) + salary(hourlyRate, hoursWorked);
    ...
    public static void outputResults(double totalSales){
        ...
        JOptionPane.showMessageDialog(null, "You earned a total: " + round.format(totalSales));
